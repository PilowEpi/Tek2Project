...
class Texture
{
    ...
    Texture(const std::string message, rl::Font font, int size, rl::Color color); // 3d billboard Message
    ...
    void drawBillboard(rl::Camera3d cam, rl::Vec3 pos, float size, rl::Color color);
